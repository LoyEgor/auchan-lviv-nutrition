...
const RAW_DICT: Record<string, string[]> = {
  ...
  // drinks
  кофе: ["кава"],
  газировка: ["газований", "газована"],
  газированная: ["газований", "газована"],
  ...
  блинчики: ["млинці"],
  оладьи: ["оладки"],
  // brands whose Cyrillic spelling is phonetically too far for transliteration
  // to reach (vowel divergence / first-letter swap).
  лейс: ["lays"],
  спрайт: ["sprite"],
};
